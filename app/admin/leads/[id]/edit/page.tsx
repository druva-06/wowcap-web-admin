...
export default function EditLeadPage({ params }: { params: { id: string } }) {
  ...
  // Pre-filled form data (simulating existing lead data)
  const [formData, setFormData] = useState({
    ...
    preferredCollege: "University of California",
    intake: "fall2025",
    budget: "25-30",
    source: "website",
    assignedTo: "amit",
    notes: "Student is very serious about Fall 2025 intake. Has good academic background and work experience.",
  })
  ...
  const handleUpdate = () => {
    console.log("[v0] Updating lead:", formData)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Edit Lead</h1>
            <p className="text-sm text-gray-600 mt-1">Update lead information - Lead ID: {params.id}</p>
          </div>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select>
                  <SelectTrigger>
                    <SelectValue placeholder="USA, Canada, UK" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="usa">USA</SelectItem>
                    <SelectItem value="uk">UK</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select>
                  <SelectTrigger>
                    <SelectValue placeholder="Computer Science, Data Science, AI/ML" />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {currentStep < totalSteps ? (
                ...
                <Button onClick={handleUpdate} className="bg-green-600 hover:bg-green-700 text-white gap-2">
