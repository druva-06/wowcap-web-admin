...
export default function EditLeadPage({ params }: { params: { id: string } }) {
        ...
        const fetchLeadData = async () => {
            try {
                ...
                if (response.success && response.data) {
                    ...
                    try {
                        personalDetails = lead.encrypted_personal_details ? JSON.parse(lead.encrypted_personal_details) : {}
                        academicDetails = lead.encrypted_academic_details ? JSON.parse(lead.encrypted_academic_details) : {}
                        preferences = lead.encrypted_preferences ? JSON.parse(lead.encrypted_preferences) : {}
                    } catch (e) {
                    ...
                    setFormData({
                        ...
                        leadStatus: lead.status || "WARM",

                        currentEducation: academicDetails.current_education || "",
                        degree: academicDetails.degree || "",
                        university: academicDetails.university || "",
                        percentage: academicDetails.percentage || "",
                        yearOfPassing: academicDetails.year_of_passing || "",
                        workExperience: academicDetails.work_experience || "",
                        ielts: academicDetails.ielts || "",
                        toefl: academicDetails.toefl || "",
                        gre: academicDetails.gre || "",
                        gmat: academicDetails.gmat || "",

                        preferredCountries: lead.preferred_countries ? lead.preferred_countries.split(",") : [],
                        preferredCourses: lead.preferred_courses ? lead.preferred_courses.split(",") : [],
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Prepare the request payload matching backend API (excluding email and phone)
            const requestBody = {
            ...
            const response = await api.put(`/api/leads/${params.id}`, requestBody)
            ...
            if (response.success) {
                ...
                toast({
                    title: "Error",
                    description: response.message || "Failed to update lead. Please try again.",
                    variant: "destructive",
                })
                ...
                <div className="mb-8">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p className="text-gray-600 mt-2">Update lead information - Lead ID: {params.id}</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                readOnly
                                                disabled
                                                className="pl-10 border-gray-300 bg-gray-100 cursor-not-allowed"
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-3 w-full sm:w-auto">
                                {currentStep < totalSteps ? (
                                    <Button
                                        ...
                                        className="gap-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-6 text-base font-semibold shadow-lg w-full sm:flex-none"
                                    >
                                        Next Step
                                    ...
                                    <Button
                                        ...
                                        disabled={isSubmitting}
                                        className="gap-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-8 py-6 text-base font-semibold shadow-lg w-full sm:flex-none"
                                    >
                                        {isSubmitting ? (
                                            <>
